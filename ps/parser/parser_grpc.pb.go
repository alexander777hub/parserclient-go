...
const (
	ParserService_ParseTable_FullMethodName = "/parser.ParserService/ParseTable"
)
...
type ParserServiceClient interface {
	ParseTable(ctx context.Context, in *ParseRequest, opts ...grpc.CallOption) (*ParseResponse, error)
}
...
func (c *parserServiceClient) ParseTable(ctx context.Context, in *ParseRequest, opts ...grpc.CallOption) (*ParseResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ParseResponse)
	err := c.cc.Invoke(ctx, ParserService_ParseTable_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ParserServiceServer interface {
	ParseTable(context.Context, *ParseRequest) (*ParseResponse, error)
...
func (UnimplementedParserServiceServer) ParseTable(context.Context, *ParseRequest) (*ParseResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ParseTable not implemented")
}
...
func _ParserService_ParseTable_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ParseRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ParserServiceServer).ParseTable(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ParserService_ParseTable_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ParserServiceServer).ParseTable(ctx, req.(*ParseRequest))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _ParserService_ParseTable_Handler,
		},
	},
